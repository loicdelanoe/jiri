    ...
    <main class="flex flex-col gap-4 mx-4">
        ...
        <form action="/jiri" method="post" class="flex flex-col gap-4 items-start">
            ...
            <div>
                ...
                <input class="border rounded-md px-2" type="text" name="starting_at" id="starting_at">
            </div>
            <button class="rounded-md bg-blue-500 text-white px-4" type="submit">Créer ce jiri</button>
        </form>
